...
>
    <div class="px-3 py-2 bg-[#68778B] flex items-center sticky top-0 z-10 shadow-md">
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <a href="{{ url('/uplpu/lpudashboard') }}" class="flex items-center space-x-2 p-3 rounded bg-[#68778B] hover:bg-gray-500 transition-all duration-300 ease-in-out">
                <img src="/images/dash.png" alt="Dashboard" class="w-5 h-5">
                <span>Dashboard</span>
            </a>
            <a href="{{ url('/uplpu/lpuinput') }}" class="group flex items-center space-x-2 p-3 rounded hover:bg-[#CBD2DA] transition-all duration-300 ease-in-out font-semibold text-[#003B69]">
            ...
            <a href="{{ url('/uplpu/lpu') }}" class="group flex items-center space-x-2 p-3 rounded hover:bg-[#CBD2DA] transition-all duration-300 ease-in-out font-semibold ">
...
<main class="p-4 sm:p-6 space-y-6">
    <form action="{{ route('lpu.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select id="kategori_berita" name="kategori_berita" class="w-full border rounded px-3 py-2 text-gray-500">
                                                ...
                                                <option value="Acara lpu (Berkala)">Acara lpu (Berkala)</option>
                                                ...
                                                <option value="Laporan Bidang lpu/Tim Konten Media Baru (Berkala)">Laporan Bidang lpu/Tim Konten Media Baru (Berkala)</option>
                ...
                <div>
                    ...
                    <input type="text" value="LPU" class="w-full border rounded px-3 py-2 bg-gray-100 text-gray-700" readonly>
