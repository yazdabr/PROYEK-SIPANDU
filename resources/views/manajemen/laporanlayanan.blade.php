...
<body class="flex min-h-screen bg-[#EDF2F9]">
    ...
    <aside class="w-64 bg-[#8E9BAB] text-white flex flex-col" 
           x-data="{ 
               open: false, 
               menus: [
                {icon: '/images/panahputih.png', text: 'Statistik Arsip', route: '{{ url('/mastatis') }}'},
                {icon: '/images/panahputih.png', text: 'Laporan Arsip Unit', route: '{{ url('/laporanarsip') }}'},
                {icon: '/images/panahbiru.png', text: 'Laporan Layanan Arsip Publik', route: '{{ url('/laporanlayanan') }}'}
               ]
           }">
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <div class="ml-2 mt-2 space-y-2 p-1">
                <template x-for="(menu, i) in menus" :key="i">
                    ...
                    :class="menu.text === 'Laporan Layanan Arsip Publik' ? 'text-[#003B69] font-semibold' : 'text-white'">
        ...
        <main class="p-6 space-y-6">
            ...
            <div class="bg-white p-5 rounded shadow">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="font-bold text-lg text-[#003B69]">Laporan Layanan Arsip Publik</h2>
                    <button class="font-semibold bg-[#B1B1B1] text-white px-4 py-2 rounded shadow hover:bg-[#898989] transition">
                        Cetak PDF
                    </button>
                </div>
