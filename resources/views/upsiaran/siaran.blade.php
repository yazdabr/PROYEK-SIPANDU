...
>
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <a href="{{ url('/upsiaran/siarandashboard') }}"
        ...
        <a href="{{ url('/upsiaran/siaraninput') }}"
    ...
    <div class="flex-1 flex flex-col overflow-x-hidden">
        ...
        <main class="p-4 md:p-6 space-y-6 flex-1 overflow-y-auto" x-data="{ showModal: false, selected: null }">
            ...
            <div class="bg-white p-4 md:p-5 rounded shadow">
                ...
                <form action="{{ url()->current() }}" method="GET" class="mb-4 flex flex-wrap items-center gap-2">
                    ...
                    <button type="button" onclick="window.location.href='{{ url('/upsiaran/siaran') }}'" 
        ...
        <a href="{{ route('siaranedit.edit', $item->id) }}" 
        ...
        <form action="{{ route('siaran.destroy', $item->id) }}" method="POST" class="inline deleteForm">
            @csrf
            @method('DELETE')
