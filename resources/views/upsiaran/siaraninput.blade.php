...
>
    ...
    <nav class="flex-1 p-4 space-y-2">
        ...
        <a href="{{ url('/upsiaran/siarandashboard') }}" class="flex items-center space-x-2 p-3 rounded bg-[#68778B] hover:bg-gray-500 transition">
            <img src="/images/dash.png" alt="Dashboard" class="w-5 h-5">
            <span>Dashboard</span>
        </a>
        <a href="{{ url('/upsiaran/siaraninput') }}" class="group flex items-center space-x-2 p-3 rounded hover:bg-[#CBD2DA] font-semibold text-[#003B69]">
        ...
        <a href="{{ url('/upsiaran/siaran') }}" class="group flex items-center space-x-2 p-3 rounded hover:bg-[#CBD2DA] font-semibold">
        ...
        <div class="bg-white p-4 sm:p-6 rounded shadow">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" value="SIARAN" class="w-full border rounded px-3 py-2 bg-gray-100 text-gray-700" readonly>
