...
<body class="flex bg-[#EDF2F9]" x-data="layout">
    ...
    >
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <a href="{{ url('/upkeuangan/keuanganinput') }}" class="group flex items-center space-x-2 p-3 rounded hover:bg-[#CBD2DA] transition-all duration-300 ease-in-out font-semibold">
