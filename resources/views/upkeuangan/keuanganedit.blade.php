...
<main class="p-4 sm:p-6 space-y-6">
    <form action="{{ route('keuanganedit.update', $keuangan->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-y-4">
                <div>
                    ...
                    <input type="text" name="judul" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->judul }}" required>
                </div>

                <div>
                    <label class="font-medium mb-1 block">Nomor</label>
                    <input type="text" name="nomor" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->nomor_arsip }}">
                </div>
                ...
                <div class="w-full">
                    ...
                    <div class="relative w-full">
                        <select id="kategori_berita" name="kategori_berita" 
                            ...
                            <option value="-" {{ $keuangan->kategori_berita == '-' ? 'selected' : '' }}>-</option>
                                            <option value="-" {{ $keuangan->kategori_berita == '-' ? 'selected' : '' }}>-</option>
                                            <option value="Keputusan LPP RRI dan Pertimbangannya (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Keputusan LPP RRI dan Pertimbangannya (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Kebijakan LPP RRI dan Dokumen Pendukungnya (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Kebijakan LPP RRI dan Dokumen Pendukungnya (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Rencana Proyek dan Anggaran Tahunnya (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Rencana Proyek dan Anggaran Tahunnya (Tersedia setiap saat)' ? 'selected' : '' }}>
                                                Rencana Proyek dan Anggaran Tahunnya (Tersedia setiap saat)
                                            </option>
                                            <option value="Rencana Strategis LPP RRI (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Rencana Strategis LPP RRI (Tersedia setiap saat)' ? 'selected' : '' }}>
                                                Rencana Strategis LPP RRI (Tersedia setiap saat)
                                            </option>
                                            <option value="Informasi tentang PPID LPP RRI (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Informasi tentang PPID LPP RRI (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Informasi tentang Penindakan atas Pelanggaran yang dilakukan oleh Pegawai LPP RRI (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Informasi tentang Penindakan atas Pelanggaran yang dilakukan oleh Pegawai LPP RRI (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Informasi Daftar dan Hasil Penelitian LPP RRI (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Informasi Daftar dan Hasil Penelitian LPP RRI (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Informasi Laporan Harta Kekayaan Pejabat Negara di LPP RRI yang telah diverifikasi oleh KPK (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Informasi Laporan Harta Kekayaan Pejabat Negara di LPP RRI yang telah diverifikasi oleh KPK (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Perjanjian LPP RRI dengan Pihak Ketiga (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Perjanjian LPP RRI dengan Pihak Ketiga (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Informasi dalam pertemuan yang bersifat untuk umum (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Informasi dalam pertemuan yang bersifat untuk umum (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Prosedur Kerja yang Berkaitan dengan Publik (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Prosedur Kerja yang Berkaitan dengan Publik (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Laporan Layanan Akses Informasi (Tersedia setiap saat)"
                                                {{ $keuangan->kategori_berita == 'Laporan Layanan Akses Informasi (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Risalah Rapat dari Proses Pembentukan Peraturan, Keputusan atau Kebijakan (Berkala)"
                                                {{ $keuangan->kategori_berita == 'Risalah Rapat dari Proses Pembentukan Peraturan, Keputusan atau Kebijakan (Berkala)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Dokumen Rancangan Peraturan, Keputusan Kebijakan yang dibentuk (Berkala)"
                                                {{ $keuangan->kategori_berita == 'Dokumen Rancangan Peraturan, Keputusan Kebijakan yang dibentuk (Berkala)' ? 'selected' : '' }}>
                                                Dokumen Rancangan Peraturan, Keputusan Kebijakan yang dibentuk (Berkala)
                                            </option>
                                            <option value="Dokumen Penghargaan (Berkala)"
                                                {{ $keuangan->kategori_berita == 'Dokumen Penghargaan (Berkala)' ? 'selected' : '' }}>
                                                Dokumen Penghargaan (Berkala)
                                            </option>
                                            <option value="LHKPN Dewas dan Direksi (Berkala)"
                                                {{ $keuangan->kategori_berita == 'LHKPN Dewas dan Direksi (Berkala)' ? 'selected' : '' }}>
                                                LHKPN Dewas dan Direksi (Berkala)
                                            </option>
                                            <option value="Hasil Monitoring dan Evaluasi KIP (Berkala)"
                                                {{ $keuangan->kategori_berita == 'Hasil Monitoring dan Evaluasi KIP (Berkala)' ? 'selected' : '' }}>
                                                Hasil Monitoring dan Evaluasi KIP (Berkala)
                                            </option>
                                            <option value="Pedoman HUT LPP RRI 80th (Berkala)"
                                                {{ $keuangan->kategori_berita == 'Pedoman HUT LPP RRI 80th (Berkala)' ? 'selected' : '' }}>
                                                Pedoman HUT LPP RRI 80th (Berkala)
                                            </option>
                                            <option value="Informasi yang Wajib Diumumkan Tanpa Penundaan (Serta Merta)"
                                                {{ $keuangan->kategori_berita == 'Informasi yang Wajib Diumumkan Tanpa Penundaan (Serta Merta)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Menyangkut Ancaman Terhadap Hajat Hidup Orang Banyak dan Ketertiban Umum (Serta Merta)"
                                                {{ $keuangan->kategori_berita == 'Menyangkut Ancaman Terhadap Hajat Hidup Orang Banyak dan Ketertiban Umum (Serta Merta)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Pasal 17 UU 14 Tahun 2008 (Dikecualikan)"
                                                {{ $keuangan->kategori_berita == 'Pasal 17 UU 14 Tahun 2008 (Dikecualikan)' ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="indeks" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->indeks }}">
                </div>

                <div>
                    <label class="font-medium mb-1 block">Tanggal</label>
                    <input type="date" name="tanggal" class="w-full border rounded px-3 py-2 text-gray-500 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->tanggal }}">
                </div>

                <div>
                    <label class="font-medium mb-1 block">Uraian Informasi</label>
                    <textarea name="uraian_informasi" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69] min-h-[100px]">{{ $keuangan->uraian_informasi }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <select name="tingkat_perkembangan" class="w-full border rounded px-3 py-2 appearance-none focus:ring-[#003B69] focus:border-[#003B69]" required>
                        <option value="Asli" {{ old('tingkat_perkembangan', $keuangan->tingkat_perkembangan) == 'Asli' ? 'selected' : '' }}>Asli</option>
                        <option value="Fotocopy" {{ old('tingkat_perkembangan', $keuangan->tingkat_perkembangan) == 'Fotocopy' ? 'selected' : '' }}>Fotocopy</option>
                        <option value="Asli & Fotocopy" {{ old('tingkat_perkembangan', $keuangan->tingkat_perkembangan) == 'Asli & Fotocopy' ? 'selected' : '' }}>Asli & Fotocopy</option>
                        <option value="Softcopy" {{ old('tingkat_perkembangan', $keuangan->tingkat_perkembangan) == 'Softcopy' ? 'selected' : '' }}>Softcopy</option>
                    </select>
                </div>
                ...
                <div class="w-full">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">          
                        <input type="number" name="jumlah" min="0" class="w-full sm:w-32 border rounded px-3 py-2 text-center" placeholder="0" value="{{ $keuangan->jumlah }}">
                        ...
                        <div class="relative w-full sm:w-40">
                            <select 
                                ...
                                required
                                    >
                                <option value="lembar" {{ old('satuan', $keuangan->satuan) == 'lembar' ? 'selected' : '' }}>Lembar</option>
                                <option value="jilid" {{ old('satuan', $keuangan->satuan) == 'jilid' ? 'selected' : '' }}>Jilid</option>
                                <option value="bundle" {{ old('satuan', $keuangan->satuan) == 'bundle' ? 'selected' : '' }}>Bundle</option>
                            </select>
                    ...
                    <div class="bg-white p-4 sm:p-6 rounded shadow mt-6">
                        ...
                        <div class="grid grid-cols-1 gap-y-4">
                            <div>
                                ...
                                <input type="text" name="ruangan" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->ruangan }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">No Box</label>
                                <input type="text" name="no_box" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->no_box }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">No Filling</label>
                                <input type="text" name="no_filling" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->no_filling }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">No Laci</label>
                                <input type="text" name="no_laci" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->no_laci }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">No Folder</label>
                                <input type="text" name="no_folder" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $keuangan->no_folder }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">Keterangan</label>
                                <textarea name="keterangan" class="w-full border rounded px-3 py-2 min-h-[100px] focus:ring-[#003B69] focus:border-[#003B69]">{{ $keuangan->keterangan }}</textarea>
                            </div>
                            <div>
                                ...
                                @if($keuangan->upload_dokumen)
                                    <p class="mt-2 text-sm text-gray-600">File lama: 
                                        <a href="{{ asset('storage/'.$keuangan->upload_dokumen) }}" target="_blank" class="text-blue-600 underline hover:text-blue-800">
                                            Lihat Dokumen
                                        </a>
                                    </p>
                                @endif
                        ...
                        <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 mt-8">
                            <a href="{{ route('keuangan.index') }}" class="text-center bg-gray-400 text-white px-4 py-2 rounded shadow hover:bg-gray-500 transition-all duration-200">Kembali</a>
