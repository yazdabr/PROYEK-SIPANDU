            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select id="kategori_berita" name="kategori_berita" class="w-full border rounded px-3 py-2 text-gray-500">
                                            ...
                                            <option value="Laporan umum Audited (Berkala)">Laporan umum Audited (Berkala)</option>
                                            <option value="Rencana dan LRA (Berkala)">Rencana dan LRA (Berkala)</option>
                                            <option value="Neraca umum (Berkala)">Neraca umum (Berkala)</option>
                                            ...
                                            <option value="Acara umum (Berkala)">Acara umum (Berkala)</option>
                                            ...
                                            <option value="Laporan Bidang umum/Tim Konten Media Baru (Berkala)">Laporan Bidang umum/Tim Konten Media Baru (Berkala)</option>
                                            <option value="Laporan Bidang umum (Berkala)">Laporan Bidang umum (Berkala)</option>
                                            <option value="Laporan Bidang umum dan Umum (Berkala)">Laporan Bidang umum dan Umum (Berkala)</option>
                                            ...
                                            <option value="Opini BPK RI atas Laporan umum LPP RRI (Berkala)">Opini BPK RI atas Laporan umum LPP RRI (Berkala)</option>
                ...
                <div>
                    ...
                    <input type="text" value="TATA USAHA UMUM" class="w-full border rounded px-3 py-2 bg-gray-100 text-gray-700" readonly>
