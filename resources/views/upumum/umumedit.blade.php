...
<head>
    ...
    <title>TATA USAHA UMUM - PORTAL DATA TERPADU</title>
...
>
    <div class="px-3 py-2 bg-[#68778B] flex items-center sticky top-0 z-10 shadow-md">
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <a href="{{ url('/upumum/umumdashboard') }}" class="flex items-center space-x-2 p-3 rounded bg-[#68778B] hover:bg-gray-500 transition-all duration-300 ease-in-out">
                <img src="/images/dash.png" alt="Dashboard" class="w-5 h-5">
                <span>Dashboard</span>
            </a>
            <a href="{{ url('/upumum/umuminput') }}" class="group flex items-center space-x-2 p-3 rounded hover:bg-[#CBD2DA] transition-all duration-300 ease-in-out font-semibold text-[#003B69]">
            ...
            <a href="{{ url('/upumum/umum') }}" class="group flex items-center space-x-2 p-3 rounded hover:bg-[#CBD2DA] transition-all duration-300 ease-in-out font-semibold ">
...
<main class="p-4 sm:p-6 space-y-6">
    <form action="{{ route('umumedit.update', $umum->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-y-4">
                <div>
                    ...
                    <input type="text" name="judul" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->judul }}" required>
                </div>

                <div>
                    <label class="font-medium mb-1 block">Nomor</label>
                    <input type="text" name="nomor" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->nomor_arsip }}">
                </div>
                    ...
                    <div class="relative w-full">
                        <select id="kode_klasifikasi" name="kode_klasifikasi"
                            ...
                            @foreach($kodeKlasifikasi as $kode)
                                <option value="{{ $kode->id }}" {{ $umum->kode_klasifikasi_id == $kode->id ? 'selected' : '' }}>
                ...
                <div class="w-full">
                    ...
                    <div class="relative w-full">
                        <select id="kategori_berita" name="kategori_berita" 
                            ...
                            <option value="-" {{ $umum->kategori_berita == '-' ? 'selected' : '' }}>-</option>
                                            <option value="-" {{ $umum->kategori_berita == '-' ? 'selected' : '' }}>-</option>
                                            <option value="Keputusan LPP RRI dan Pertimbangannya (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Keputusan LPP RRI dan Pertimbangannya (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Kebijakan LPP RRI dan Dokumen Pendukungnya (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Kebijakan LPP RRI dan Dokumen Pendukungnya (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Rencana Proyek dan Anggaran Tahunnya (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Rencana Proyek dan Anggaran Tahunnya (Tersedia setiap saat)' ? 'selected' : '' }}>
                                                Rencana Proyek dan Anggaran Tahunnya (Tersedia setiap saat)
                                            </option>
                                            <option value="Rencana Strategis LPP RRI (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Rencana Strategis LPP RRI (Tersedia setiap saat)' ? 'selected' : '' }}>
                                                Rencana Strategis LPP RRI (Tersedia setiap saat)
                                            </option>
                                            <option value="Informasi tentang PPID LPP RRI (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Informasi tentang PPID LPP RRI (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Informasi tentang Penindakan atas Pelanggaran yang dilakukan oleh Pegawai LPP RRI (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Informasi tentang Penindakan atas Pelanggaran yang dilakukan oleh Pegawai LPP RRI (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Informasi Daftar dan Hasil Penelitian LPP RRI (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Informasi Daftar dan Hasil Penelitian LPP RRI (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Informasi Laporan Harta Kekayaan Pejabat Negara di LPP RRI yang telah diverifikasi oleh KPK (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Informasi Laporan Harta Kekayaan Pejabat Negara di LPP RRI yang telah diverifikasi oleh KPK (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Perjanjian LPP RRI dengan Pihak Ketiga (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Perjanjian LPP RRI dengan Pihak Ketiga (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Informasi dalam pertemuan yang bersifat untuk umum (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Informasi dalam pertemuan yang bersifat untuk umum (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Prosedur Kerja yang Berkaitan dengan Publik (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Prosedur Kerja yang Berkaitan dengan Publik (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Laporan Layanan Akses Informasi (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Laporan Layanan Akses Informasi (Tersedia setiap saat)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Profil Lengkap Pimpinan dan Pegawai (Tersedia setiap saat)"
                                                {{ $umum->kategori_berita == 'Profil Lengkap Pimpinan dan Pegawai (Tersedia setiap saat)' ? 'selected' : '' }}>
                                                Profil Lengkap Pimpinan dan Pegawai (Tersedia setiap saat)
                                            </option>
                                            <option value="Informasi Berkaitan dengan Profile LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Informasi Berkaitan dengan Profile LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Informasi Berkaitan dengan Profile LPP RRI (Berkala)
                                            </option>
                                            <option value="Alamat LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Alamat LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Alamat LPP RRI (Berkala)
                                            </option>
                                            <option value="Struktur Organisasi (Berkala)"
                                                {{ $umum->kategori_berita == 'Struktur Organisasi (Berkala)' ? 'selected' : '' }}>
                                                Struktur Organisasi (Berkala)
                                            </option>
                                            <option value="Sejarah Singkat LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Sejarah Singkat LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Sejarah Singkat LPP RRI (Berkala)
                                            </option>
                                            <option value="Profil Pejabat LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Profil Pejabat LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Profil Pejabat LPP RRI (Berkala)
                                            </option>
                                            <option value="RKAKL LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'RKAKL LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                RKAKL LPP RRI (Berkala)
                                            </option>
                                            <option value="Informasi Agenda Terkait Pelaksanaan Tugas LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Informasi Agenda Terkait Pelaksanaan Tugas LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Informasi Agenda Terkait Pelaksanaan Tugas LPP RRI (Berkala)
                                            </option>
                                            <option value="DIPA (Berkala)"
                                                {{ $umum->kategori_berita == 'DIPA (Berkala)' ? 'selected' : '' }}>
                                                DIPA (Berkala)
                                            </option>
                                            <option value="Informasi Penerimaan Calon Pegawai LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Informasi Penerimaan Calon Pegawai LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Informasi Penerimaan Calon Pegawai LPP RRI (Berkala)
                                            </option>
                                            <option value="Laporan umum Audited (Berkala)"
                                                {{ $umum->kategori_berita == 'Laporan umum Audited (Berkala)' ? 'selected' : '' }}>
                                                Laporan umum Audited (Berkala)
                                            </option>
                                            <option value="Rencana dan LRA (Berkala)"
                                                {{ $umum->kategori_berita == 'Rencana dan LRA (Berkala)' ? 'selected' : '' }}>
                                                Rencana dan LRA (Berkala)
                                            </option>
                                            <option value="Neraca umum (Berkala)"
                                                {{ $umum->kategori_berita == 'Neraca umum (Berkala)' ? 'selected' : '' }}>
                                                Neraca umum (Berkala)
                                            </option>
                                            <option value="Laporan Arus Kas dan CaLK (Berkala)"
                                                {{ $umum->kategori_berita == 'Laporan Arus Kas dan CaLK (Berkala)' ? 'selected' : '' }}>
                                                Laporan Arus Kas dan CaLK (Berkala)
                                            </option>
                                            <option value="Daftar Investasi dan Asset (Administrasi BMN) (Berkala)"
                                                {{ $umum->kategori_berita == 'Daftar Investasi dan Asset (Administrasi BMN) (Berkala)' ? 'selected' : '' }}>
                                                Daftar Investasi dan Asset (Administrasi BMN) (Berkala)
                                            </option>
                                            <option value="Acara Siaran (Berkala)"
                                                {{ $umum->kategori_berita == 'Acara Siaran (Berkala)' ? 'selected' : '' }}>
                                                Acara Siaran (Berkala)
                                            </option>
                                            <option value="Laporan Bidang TMB (Berkala)"
                                                {{ $umum->kategori_berita == 'Laporan Bidang TMB (Berkala)' ? 'selected' : '' }}>
                                                Laporan Bidang TMB (Berkala)
                                            </option>
                                            <option value="Laporan Bidang Pemberitaan/Tim Penyiaran (Berkala)"
                                                {{ $umum->kategori_berita == 'Laporan Bidang Pemberitaan/Tim Penyiaran (Berkala)' ? 'selected' : '' }}>
                                                Laporan Bidang Pemberitaan/Tim Penyiaran (Berkala)
                                            </option>
                                            <option value="Laporan Bidang Siaran/Tim Konten Media Baru (Berkala)"
                                                {{ $umum->kategori_berita == 'Laporan Bidang Siaran/Tim Konten Media Baru (Berkala)' ? 'selected' : '' }}>
                                                Laporan Bidang Siaran/Tim Konten Media Baru (Berkala)
                                            </option>
                                            <option value="Laporan Bidang umum (Berkala)"
                                                {{ $umum->kategori_berita == 'Laporan Bidang umum (Berkala)' ? 'selected' : '' }}>
                                                Laporan Bidang umum (Berkala)
                                            </option>
                                            <option value="Laporan Bidang umum dan Umum (Berkala)"
                                                {{ $umum->kategori_berita == 'Laporan Bidang umum dan Umum (Berkala)' ? 'selected' : '' }}>
                                                Laporan Bidang umum dan Umum (Berkala)
                                            </option>
                                            <option value="Daftar Informasi Publik LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Daftar Informasi Publik LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Daftar Informasi Publik LPP RRI (Berkala)
                                            </option>
                                            <option value="Laporan Akuntabilitas (Berkala)"
                                                {{ $umum->kategori_berita == 'Laporan Akuntabilitas (Berkala)' ? 'selected' : '' }}>
                                                Laporan Akuntabilitas (Berkala)
                                            </option>
                                            <option value="ELHKPN LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'ELHKPN LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                ELHKPN LPP RRI (Berkala)
                                            </option>
                                            <option value="Regulasi dan Rancangan Keterbukaan Informasi Publik (Berkala)"
                                                {{ $umum->kategori_berita == 'Regulasi dan Rancangan Keterbukaan Informasi Publik (Berkala)' ? 'selected' : '' }}>
                                                Regulasi dan Rancangan Keterbukaan Informasi Publik (Berkala)
                                            </option>
                                            <option value="Rancangan Peraturan di LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Rancangan Peraturan di LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Rancangan Peraturan di LPP RRI (Berkala)
                                            </option>
                                            <option value="Regulasi LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Regulasi LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Regulasi LPP RRI (Berkala)
                                            </option>
                                            <option value="SOP (Berkala)"
                                                {{ $umum->kategori_berita == 'SOP (Berkala)' ? 'selected' : '' }}>
                                                SOP (Berkala)
                                            </option>
                                            <option value="Pengadaan Barang dan Jasa (Berkala)"
                                                {{ $umum->kategori_berita == 'Pengadaan Barang dan Jasa (Berkala)' ? 'selected' : '' }}>
                                                Pengadaan Barang dan Jasa (Berkala)
                                            </option>
                                            <option value="Standar Pelayanan (Berkala)"
                                                {{ $umum->kategori_berita == 'Standar Pelayanan (Berkala)' ? 'selected' : '' }}>
                                                Standar Pelayanan (Berkala)
                                            </option>
                                            <option value="Maklumat Pelayanan (Berkala)"
                                                {{ $umum->kategori_berita == 'Maklumat Pelayanan (Berkala)' ? 'selected' : '' }}>
                                                Maklumat Pelayanan (Berkala)
                                            </option>
                                            <option value="Ringkasan Program Strategis LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Ringkasan Program Strategis LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Ringkasan Program Strategis LPP RRI (Berkala)
                                            </option>
                                            <option value="Dokumen Surat Menyurat (Berkala)"
                                                {{ $umum->kategori_berita == 'Dokumen Surat Menyurat (Berkala)' ? 'selected' : '' }}>
                                                Dokumen Surat Menyurat (Berkala)
                                            </option>
                                            <option value="Informasi Terkait Penanganan Covid-19 (Berkala)"
                                                {{ $umum->kategori_berita == 'Informasi Terkait Penanganan Covid-19 (Berkala)' ? 'selected' : '' }}>
                                                Informasi Terkait Penanganan Covid-19 (Berkala)
                                            </option>
                                            <option value="Opini BPK RI atas Laporan umum LPP RRI (Berkala)"
                                                {{ $umum->kategori_berita == 'Opini BPK RI atas Laporan umum LPP RRI (Berkala)' ? 'selected' : '' }}>
                                                Opini BPK RI atas Laporan umum LPP RRI (Berkala)
                                            </option>
                                            <option value="Penyelenggaraan Satu Data Indonesia (Berkala)"
                                                {{ $umum->kategori_berita == 'Penyelenggaraan Satu Data Indonesia (Berkala)' ? 'selected' : '' }}>
                                                Penyelenggaraan Satu Data Indonesia (Berkala)
                                            </option>
                                            <option value="Bintang Radio RRI Tingkat Nasional (Berkala)"
                                                {{ $umum->kategori_berita == 'Bintang Radio RRI Tingkat Nasional (Berkala)' ? 'selected' : '' }}>
                                                Bintang Radio RRI Tingkat Nasional (Berkala)
                                            </option>
                                            <option value="Formulir Pendaftaran PTQ RRI ke-53 Tahun 2023 (Berkala)"
                                                {{ $umum->kategori_berita == 'Formulir Pendaftaran PTQ RRI ke-53 Tahun 2023 (Berkala)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Risalah Rapat dari Proses Pembentukan Peraturan, Keputusan atau Kebijakan (Berkala)"
                                                {{ $umum->kategori_berita == 'Risalah Rapat dari Proses Pembentukan Peraturan, Keputusan atau Kebijakan (Berkala)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Menyangkut Ancaman Terhadap Hajat Hidup Orang Banyak dan Ketertiban Umum (Serta Merta)"
                                                {{ $umum->kategori_berita == 'Menyangkut Ancaman Terhadap Hajat Hidup Orang Banyak dan Ketertiban Umum (Serta Merta)' ? 'selected' : '' }}>
                                            ...
                                            <option value="Pasal 17 UU 14 Tahun 2008 (Dikecualikan)"
                                                {{ $umum->kategori_berita == 'Pasal 17 UU 14 Tahun 2008 (Dikecualikan)' ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="indeks" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->indeks }}">
                </div>

                <div>
                    <label class="font-medium mb-1 block">Tanggal</label>
                    <input type="date" name="tanggal" class="w-full border rounded px-3 py-2 text-gray-500 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->tanggal }}">
                </div>

                <div>
                    <label class="font-medium mb-1 block">Uraian Informasi</label>
                    <textarea name="uraian_informasi" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69] min-h-[100px]">{{ $umum->uraian_informasi }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <select name="tingkat_perkembangan" class="w-full border rounded px-3 py-2 appearance-none focus:ring-[#003B69] focus:border-[#003B69]" required>
                        <option value="Asli" {{ old('tingkat_perkembangan', $umum->tingkat_perkembangan) == 'Asli' ? 'selected' : '' }}>Asli</option>
                        <option value="Fotocopy" {{ old('tingkat_perkembangan', $umum->tingkat_perkembangan) == 'Fotocopy' ? 'selected' : '' }}>Fotocopy</option>
                        <option value="Asli & Fotocopy" {{ old('tingkat_perkembangan', $umum->tingkat_perkembangan) == 'Asli & Fotocopy' ? 'selected' : '' }}>Asli & Fotocopy</option>
                        <option value="Softcopy" {{ old('tingkat_perkembangan', $umum->tingkat_perkembangan) == 'Softcopy' ? 'selected' : '' }}>Softcopy</option>
                    </select>
                </div>
                ...
                <div class="w-full">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">          
                        <input type="number" name="jumlah" min="0" class="w-full sm:w-32 border rounded px-3 py-2 text-center" placeholder="0" value="{{ $umum->jumlah }}">
                        ...
                        <div class="relative w-full sm:w-40">
                            <select 
                                ...
                                required
                                    >
                                <option value="lembar" {{ old('satuan', $umum->satuan) == 'lembar' ? 'selected' : '' }}>Lembar</option>
                                <option value="jilid" {{ old('satuan', $umum->satuan) == 'jilid' ? 'selected' : '' }}>Jilid</option>
                                <option value="bundle" {{ old('satuan', $umum->satuan) == 'bundle' ? 'selected' : '' }}>Bundle</option>
                            </select>
                ...
                <div class="w-full">
                    ...
                    <input 
                        type="text" 
                        value="TATA USAHA UMUM" 
                        class="w-full border rounded px-3 py-2 bg-gray-100 text-gray-700" 
                        readonly
                    >
                    <input type="hidden" name="unit_pengolah_id" value="{{ $unitUmum->id }}">
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-white p-4 sm:p-6 rounded shadow mt-6">
                        ...
                        <div class="grid grid-cols-1 gap-y-4">
                            <div>
                                ...
                                <input type="text" name="ruangan" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->ruangan }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">No Box</label>
                                <input type="text" name="no_box" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->no_box }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">No Filling</label>
                                <input type="text" name="no_filling" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->no_filling }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">No Laci</label>
                                <input type="text" name="no_laci" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->no_laci }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">No Folder</label>
                                <input type="text" name="no_folder" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $umum->no_folder }}">
                            </div>
                            <div>
                                <label class="font-medium mb-1 block">Keterangan</label>
                                <textarea name="keterangan" class="w-full border rounded px-3 py-2 min-h-[100px] focus:ring-[#003B69] focus:border-[#003B69]">{{ $umum->keterangan }}</textarea>
                            </div>
                            <div>
                                ...
                                @if($umum->upload_dokumen)
                                    <p class="mt-2 text-sm text-gray-600">File lama: 
                                        <a href="{{ asset('storage/'.$umum->upload_dokumen) }}" target="_blank" class="text-blue-600 underline hover:text-blue-800">
                                            Lihat Dokumen
                                        </a>
                                    </p>
                                @endif
                        ...
                        <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 mt-8">
                            <a href="{{ route('umum.index') }}" class="text-center bg-gray-400 text-white px-4 py-2 rounded shadow hover:bg-gray-500 transition-all duration-200">Kembali</a>
