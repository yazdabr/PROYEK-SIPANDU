...
<header class="flex items-center bg-[#E3E8EE] px-6 py-4 sticky top-0 z-30 shadow-md">
    ...
    <script>
        ...
        // // === Logika Mobile Menu (Jatuh ke Bawah) ===
        // const mobileMenu = document.getElementById('mobile-menu');
        // const menuToggle = document.getElementById('menu-toggle');

        // menuToggle.addEventListener('click', () => {
        //     if (mobileMenu.style.maxHeight) {
        //         mobileMenu.style.maxHeight = null; // Tutup menu (animasi slide up)
        //     } else {
        //         // Buka menu (animasi slide down)
        //         mobileMenu.style.maxHeight = mobileMenu.scrollHeight + "px"; 
        //     }
        // });

        // // Opsional: Menutup mobile menu jika ukuran layar diubah ke desktop
        // window.addEventListener('resize', () => {
        //     if (window.innerWidth >= 1024) { // Jika kembali ke desktop (lg)
        //         mobileMenu.style.maxHeight = null; // Pastikan menu mobile tertutup
        //     }
        // });
    </script>
