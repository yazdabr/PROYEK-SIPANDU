...
>
    ...
    <nav class="flex-1 p-4 space-y-2">
        ...
        <a href="{{ url('/uptmb/tmb') }}" class="group flex items-center space-x-2 p-3 rounded hover:bg-[#CBD2DA] transition-all duration-300 ease-in-out font-semibold text-[#003B69]">
...
></div>
    ...
    <header class="flex items-center bg-[#E3E8EE] px-6 py-4 sticky top-0 z-30 shadow-md">
        ...
        <main class="p-4 sm:p-6 space-y-6">
            <form action="{{ route('tmbedit.update', $tmb->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white p-4 sm:p-6 rounded shadow">
                    ...
                    <div class="grid grid-cols-1 gap-y-4">
                        <div>
                            ...
                            <input type="text" name="judul" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->judul }}" required>
                        </div>

                        <div>
                            <label class="font-medium mb-1 block">Nomor</label>
                            <input type="text" name="nomor" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->nomor_arsip }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="indeks" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->indeks }}">
                        </div>

                        <div>
                            <label class="font-medium mb-1 block">Tanggal</label>
                            <input type="date" name="tanggal" class="w-full border rounded px-3 py-2 text-gray-500 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->tanggal }}">
                        </div>

                        <div>
                            <label class="font-medium mb-1 block">Uraian Informasi</label>
                            <textarea name="uraian_informasi" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69] min-h-[100px]">{{ $tmb->uraian_informasi }}</textarea>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" name="jumlah" min="0" class="w-full sm:w-32 border rounded px-3 py-2 text-center" placeholder="0" value="{{ $tmb->jumlah }}">
                ...
                <div class="bg-white p-4 sm:p-6 rounded shadow mt-6">
                    ...
                    <div class="grid grid-cols-1 gap-y-4">
                        <div>
                            ...
                            <input type="text" name="ruangan" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->ruangan }}">
                        </div>
                        <div>
                            <label class="font-medium mb-1 block">No Box</label>
                            <input type="text" name="no_box" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->no_box }}">
                        </div>
                        <div>
                            <label class="font-medium mb-1 block">No Filling</label>
                            <input type="text" name="no_filling" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->no_filling }}">
                        </div>
                        <div>
                            <label class="font-medium mb-1 block">No Laci</label>
                            <input type="text" name="no_laci" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->no_laci }}">
                        </div>
                        <div>
                            <label class="font-medium mb-1 block">No Folder</label>
                            <input type="text" name="no_folder" class="w-full border rounded px-3 py-2 focus:ring-[#003B69] focus:border-[#003B69]" value="{{ $tmb->no_folder }}">
                        </div>
                        <div>
                            <label class="font-medium mb-1 block">Keterangan</label>
                            <textarea name="keterangan" class="w-full border rounded px-3 py-2 min-h-[100px] focus:ring-[#003B69] focus:border-[#003B69]">{{ $tmb->keterangan }}</textarea>
                        </div>
                        <div>
                            ...
                            @if($tmb->upload_dokumen)
                                <p class="mt-2 text-sm text-gray-600">File lama: 
                                    <a href="{{ asset('storage/'.$tmb->upload_dokumen) }}" target="_blank" class="text-blue-600 underline hover:text-blue-800">
                                        Lihat Dokumen
                                    </a>
                                </p>
                            @endif
                    ...
                    <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 mt-8">
                        <a href="{{ route('tmb.index') }}" class="text-center bg-gray-400 text-white px-4 py-2 rounded shadow hover:bg-gray-500 transition-all duration-200">Kembali</a>
